...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Dr. Syed Hammad Wajid Talha" },
      { property: "og:title", content: "PCOS Consultation PKR 500 | Dr. Syed Hammad Wajid Talha, Gastroenterologist" },
      {
        property: "og:description",
        content: "Book a PKR 500 PCOS consultation with Dr. Syed Hammad Wajid Talha (MBBS, FCPS), Gastroenterologist, Hepatologist at Al-Qamar Hospital, Shakargarh. Personalised assessment and care plan.",
      },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "PCOS Consultation PKR 500 | Dr. Syed Hammad Wajid Talha, Gastroenterologist" },
      { name: "twitter:description", content: "Book a PKR 500 PCOS consultation with Dr. Syed Hammad Wajid Talha (MBBS, FCPS), Gastroenterologist, Hepatologist at Al-Qamar Hospital, Shakargarh. Personalised assessment and care plan." },
