  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "PCOS Consultation PKR 500 | Dr. Zaib Un Nisa, Gynaecologist" },
      {
        ...
        content: "Book a PKR 500 PCOS consultation with Dr. Zaib Un Nisa (MBBS, FCPS), Consultant Gynaecologist at Al-Qamar Hospital, Shakargarh. Personalised assessment and care plan.",
      },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "PCOS Consultation PKR 500 | Dr. Zaib Un Nisa, Gynaecologist" },
      { name: "twitter:description", content: "Book a PKR 500 PCOS consultation with Dr. Zaib Un Nisa (MBBS, FCPS), Consultant Gynaecologist at Al-Qamar Hospital, Shakargarh. Personalised assessment and care plan." },
